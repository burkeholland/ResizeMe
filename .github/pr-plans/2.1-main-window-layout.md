...
**Checklist:**
- [x] Open existing MainWindow.xaml file
- [x] Replace the entire content with the new floating menu design
    ...
    <Grid x:Name="RootGrid" Background="{ThemeResource CardBackgroundFillColorDefaultBrush}"
        ...
        <Border Grid.Row="2" Background="{ThemeResource ControlFillColorDefaultBrush}" 
            ...
            <Grid>
                ...
                <TextBlock x:Name="FooterText" Grid.Column="0" Text="Press Win+Alt+F12 to show" 
...
**Checklist:**
- [x] Create folder called "Helpers" inside ResizeMe project folder
- [x] Right-click Helpers folder → Add → Class
- [x] Name the new class "WindowPositionHelper.cs"
- [x] Copy and paste the entire content below:
...
- [x] Replace the entire file content with the new UI-focused implementation
- [x] Copy and paste the entire content below:
...
namespace ResizeMe
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        {
            Debug.WriteLine("MainWindow: Hotkey Win+Shift+F12 pressed - toggling menu");
...
- [ ] Pressing Win+Shift+F12 shows floating menu near cursor
