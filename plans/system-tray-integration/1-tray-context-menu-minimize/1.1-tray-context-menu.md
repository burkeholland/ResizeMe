...
- [ ] **Branch:** Working on `system-tray-integration`
...
- [ ] Open `ResizeMe/Services/TrayIconManager.cs`
- [ ] Add command ID constants and required P/Invoke for popup menu functions
...
#### Step 2: Build & Verify
- [ ] Save file
- [ ] Run build: `dotnet build ResizeMe.sln`
...
- [ ] File saved in correct location: `ResizeMe/Services/TrayIconManager.cs`
- [ ] No build errors: `dotnet build ResizeMe.sln`
- [ ] Events exposed: `ShowRequested`, `SettingsRequested`, `ExitRequested`
- [ ] `ShowContextMenu()` constructs menu and tracks selection
...
- [ ] ✅ Modified: `ResizeMe/Services/TrayIconManager.cs`
