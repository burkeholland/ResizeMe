...
- [ ] Open `ResizeMe/Native/WindowsApi.cs`
...
- [ ] Preference flag added and persists
- [ ] Message box appears only on first hide
- [ ] Text includes correct hotkey placeholder (will update in Step 4)
...
- [ ] ✅ Modified: `ResizeMe/Native/WindowsApi.cs`
