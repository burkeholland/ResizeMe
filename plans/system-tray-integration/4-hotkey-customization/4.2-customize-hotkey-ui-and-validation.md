...
- [ ] **Prior Substeps:** 4.1 complete (dynamic registration), Steps 1–3 complete
...
- [ ] Add static reserved list and validation method near top (inside class):
...
- [ ] Open `ResizeMe/SettingsWindow.xaml`
- [ ] Inside right column StackPanel (after Add New Preset card), before closing StackPanel, add hotkey section:
...
- [ ] Open `ResizeMe/SettingsWindow.xaml.cs`
- [ ] Add fields & load current hotkey in `OnLoaded` after presets:
...
- [ ] Add helper (SettingsWindow.xaml.cs):
