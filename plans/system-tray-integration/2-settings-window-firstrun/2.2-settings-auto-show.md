...
- [ ] In `MainWindow.xaml.cs`, locate where presets are loaded (`Loaded += async ...`). After existing logic, add enqueue for first-run check.
...
- [ ] Add method inside `MainWindow` class:
